...
const EXPORT_ROWS: ExportRow[] = [
   ...
   { label: '', key: '_spacer', type: 'kg', spacer: true },
   { label: '  (-) Devoluciones', key: 'devoluciones', type: 'currency', isSubRow: true },
   { label: '  (-) Diferencia en Precios', key: 'diferenciaPrecios', type: 'currency', isSubRow: true },
   { label: '  (-) Promociones', key: 'promociones', type: 'currency', isSubRow: true },
   { label: '  (-) Degustación $$', key: 'degustacionDol', type: 'currency', isSubRow: true },
   { label: '  (-) Cargos', key: 'cargos', type: 'currency', isSubRow: true },
   { label: '  (-) Planes Lealtad', key: 'planesLealtad', type: 'currency', isSubRow: true },
   { label: '  (-) Rapel y Acuerdos Cadenas', key: 'rapelYAcuerdos', type: 'currency', isSubRow: true },
